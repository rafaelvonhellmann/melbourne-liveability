...
export const DOMAIN_GRANULARITY: Record<DomainId, string> = {
  ...
  safety:
    "Crime recorded at suburb or council-area level and allocated to this area via crosswalk (state crime statistics: VCSA / ACT Policing) - not resident point-level.",
  health:
