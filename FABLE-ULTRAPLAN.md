...
|----|----------|----------------|--------|
| D1 | Product name + domain | Decide now; buy domain this week. HARD REQUIREMENT: a national-capable domain (.au/.com.au) - liveable.melbourne (and any .melbourne) dies at Sydney; at best it becomes a redirect. Run an IP Australia trademark screen on the chosen name (fold into D9 lawyer scope) | Phase 2, all marketing |
